...
//! \param count max number of characters to check
//!
...
//! \brief vsprintf function to support debugging
//!
//! \param buf  buffer to contain the print output
//! \param fmt  format string
//! \param args format arguments
//!
//! Variable argument printf function.  See standard-C sprintf documentation
//! for usage.  Returns the number of variable arguments that were processed.
//!
...
//! \brief sprintf function to support debugging
//!
//! \param buf  buffer to contain the print output
//! \param fmt  format string
//!
...
/*!
	...
	\param a_Format		Format control (see your stdlib references).
*/
// ----------------------------------------------------------------------------
